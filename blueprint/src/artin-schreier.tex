...
\end{lemma}
\begin{proof}
\uses{lem:ac-quadratic-adjoins-i}
...
For $x \in F$, Lemma~\ref{lem:ac-quadratic-adjoins-i} implies that one of $x$ or $-x$ is a square in $F$.

Finally, adjoining to $F$ an irreducible polynomial of degree $d$ generates a subfield of $K$
