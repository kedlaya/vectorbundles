...
we then have  $m_1 + \cdots + m_i = 0$ for $i=1,\dots,n-1$
...
We deduce (a) and (b) by applying Lemma~\ref{lem:contruct semistables} to construct a stable bundle of rank $2$ and degree $1$, then applying Lemma~\ref{cor:unique stable} for uniqueness.
\end{itemize}
