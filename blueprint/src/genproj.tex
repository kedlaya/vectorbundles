...
Since $\Ext^1_X(\cO_X, \cO_X) = H^1(X, \cO_X)$ vanishes for a generalized projective line, it follows that $F$ is trivial.
\end{proof}
...
$X \times_E E(\sqrt{-1}) \cong \mathbf{P}^1_{E(\sqrt{-1})}$ via which $\cO_X(1)$ corresponds to $\cO_{\mathbb{P}^1}(2)$.
\item[(c)]
