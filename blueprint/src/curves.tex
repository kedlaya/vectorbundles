...
By an \emph{abstract complete curve} we mean a connected, separated, regular $1$-dimensional Noetherian scheme $X$,
...
\begin{definition}
\uses{def:abstract-complete-curve}
For $F$ a vector bundle on $X$, the filtration on $F$ described in \Cref{prop:HN filtration}
