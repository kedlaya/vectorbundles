...
In practice, we can work with a Dedekind domain $R$ and a function $\deg\colon 
\Div X \to \Z$ which is positive on nonzero effective ideals and has the additional property that for any nonzero $a,b,c \in R$ with $a+b+c=0$, 
\[
\deg((c)) \leq \deg((a)) + \deg((b)).
\]
\end{definition}
